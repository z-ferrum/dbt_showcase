...
final as (
    select
        ...
        round(nb_accepted_transactions::float / (nb_all_transactions),2) as accepted_transactions_rate  -- keeps % with 2 decimals (represented as part of 1, not 100)
